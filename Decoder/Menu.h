...
typedef enum { NO_ERR, NO_MEM, AL_INIT_ERROR, AL_DISPLAY_ERROR, AL_ADDON_ERROR, AL_IMAGE_ERROR, AL_FONT_ERROR, AL_KEYBOARD_ERROR, AL_QUEUE_ERROR, FUNC_ERROR } errNo_t;
